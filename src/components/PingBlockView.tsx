...
export function PingBlockView({ block, onChange, onRemove }: Props) {
  ...
  return (
    <div className="group relative flex items-center bg-green-50 border border-green-200 rounded-lg overflow-hidden my-2 max-w-md shadow-sm transition-all hover:border-green-300">
      <div 
        className="px-2 py-3 bg-green-100/50 cursor-grab active:cursor-grabbing text-green-500 hover:text-green-700 transition-colors select-none"
        onMouseDown={onMouseDown}
      >
        <GripVertical size={16} />
      </div>
      <div className="flex items-center justify-center p-3 bg-green-200">
      ...
      <input
        ...
        placeholder="5-digit ping ID"
        className="w-32 px-4 py-2 bg-transparent outline-none text-green-900 text-sm font-mono placeholder:text-green-400"
      />
      <div className="flex-1 px-4 py-2 border-l border-green-200 text-sm font-mono text-green-700 bg-white/50">
